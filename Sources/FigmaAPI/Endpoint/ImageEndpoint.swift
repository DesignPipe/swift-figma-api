...
public class FormatParams: Encodable {
    ...
    /// Use this to export text nodes without cropping. Default: true.
...
public class SVGParams: FormatParams {
    ...
    /// Whether to simplify inside/outside strokes and use stroke attribute if possible instead of <mask>. Default:
    /// true.
