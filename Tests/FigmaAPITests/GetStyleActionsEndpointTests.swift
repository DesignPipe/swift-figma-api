...
final class GetStyleActionsEndpointTests: XCTestCase {
    // MARK: - URL Construction

    func testMakeRequestConstructsCorrectURL() throws {
        let endpoint = GetStyleActionsEndpoint(fileKey: "file123")
        ...
        XCTAssertEqual(
            ...
            "https://api.figma.com/v1/analytics/libraries/file123/style/actions"
        )
    }
    ...
    func testContentParsesLibraryActionsResponse() throws {
        ...
        let endpoint = GetStyleActionsEndpoint(fileKey: "test")
